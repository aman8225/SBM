...
import '../../model/my_items_modal/my_items_modal.dart';
...
class _MyItemsState extends State<MyItems> {
  ...
  var success1, message1, data;
  List<MyItemsModalmassege> myiteamdata = [];
  Future<MyItemsModal> myitamlistdata() async {
    ...
    print('${'${beasurl}productsByOrders'}????????????????');
    var response = await http.get(Uri.parse('${beasurl}productsByOrders'), headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
      'Authorization': 'Bearer $tokanget',
    });
    print('productsByOrders${MyItemsModal.fromJson(json.decode(response.body))}');
    print('///////////');

    progressDialog!.dismiss();

    success1 = (MyItemsModal.fromJson(json.decode(response.body)).success);
    print('??????????${MyItemsModal.fromJson(json.decode(response.body))}');
    message1 = (MyItemsModal.fromJson(json.decode(response.body)).message);

    progressDialog!.dismiss();
    if (success1 == true) {
      setState(() {
        print('??????????${MyItemsModal.fromJson(json.decode(response.body)).data}');

        print('??????????${MyItemsModal.fromJson(json.decode(response.body)).data!.length}');

        myiteamdata = (MyItemsModal.fromJson(json.decode(response.body)).data)!;
        print('??????????${myiteamdata}');
      });
      progressDialog!.dismiss();
    } else {
    ...
    return MyItemsModal.fromJson(json.decode(response.body));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // appBar: appbarnotifav(context, 'My Items'),
      body: Stack(
        children: [
          Container(
                ...
                child: FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        Get.to(() => ProdectDetails(
                                            title: myiteamdata[index]
                                                .productName!,
                                            slug: myiteamdata[index]
                                                .slug!));
                                      },
                                      child: Container(
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            Expanded(
                                                                child:
                                                                Text(
                                                                  'AED\n${myiteamdata[index].uprice == null ? '0' : myiteamdata[index].uprice}',
                                                            ...
                                                            Expanded(
                                                                child:
                                                                Text(
                                                                  'AED\n${myiteamdata[index].regularPrice == null ? '0' : myiteamdata[index].regularPrice}',
                                                                  style: textstylesubtitle2(context)!.copyWith(
                                                                      fontSize:
                                                                      9,
                                                                      decoration:
                                                      ...
                                                      (int.fromEnvironment(myiteamdata[index].discountPercent!) >= 0)?
                                                      Container(
                                                        width:
                                                        deviceWidth(
                                                            context,
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Center(
                                                              child: Text(
                                                                '${myiteamdata[index].discountPercent!.split(".")[0]}% off',
                                                                style: textstylesubtitle2(context)!.copyWith(
                                                                    color:
                                                                    colorWhite,
                                                                    fontSize:
                      ...
                      //                 Get.to(() => ProdectDetails(
                      //                     title:
                      //                         myiteamdata[index].productName!,
                      //                     slug: myiteamdata[index].slug!));
                      //               },
                      //               child: Container(
                      //                 decoration: BoxDecoration(
                      //                     border: Border.all(
                      ...
                      //                   children: [
                      //                     Image.network(
                      //                       myiteamdata[index].thumbnailImage!,
