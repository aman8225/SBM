...
import 'package:sbm/screens/all%20cotegories/prodect%20list/producr_list2.dart';
...
class ProdectListPage1 extends StatefulWidget {
  final String? title;
  final String? slug;
  final int? id;
  final int? hide;
  ...
  @override
  _ProdectListPage1State createState() => _ProdectListPage1State();
}

class _ProdectListPage1State extends State<ProdectListPage1> {
  Future? _future;
  Future? _future1;
  Future? _future2;
