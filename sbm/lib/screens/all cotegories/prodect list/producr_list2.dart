...
class ProdectListPage2 extends StatefulWidget {
  final String? title;
  final String? slug;
  final int? id;
  final int? hide;
  ...
  @override
  _ProdectListPage2State createState() => _ProdectListPage2State();
}

class _ProdectListPage2State extends State<ProdectListPage2> {
  Future? _future;
  Future? _future1;
  Future? _future2;
  ...
  Future<ViewAllCategoryDataModelMessege> veiwallcategorydatalist(
    ...
    switch (select_api) {
      ...
      case 10:
        {
          APIURL = beasurl +
              'products?page=1&searchText=${widget.Search}&orderby=id&order=DESC';
          print('APIURL1${APIURL}');
        }
        break;
      default:
